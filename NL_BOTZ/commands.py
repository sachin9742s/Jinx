...
async def start(client, message):
    ...
    if message.chat.type in ['group', 'supergroup']:
        ...
        await message.reply_photo(photo=random.choice(PICS), text=script.START_TXT.format(message.from_user.mention, temp.U_NAME, temp.B_NAME), reply_markup = InlineKeyboardMarkup(buttons), parse_mode='html')
